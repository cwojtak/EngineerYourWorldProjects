...
//Connor Wojtak
//2-26-2021
//A program to that outputs auditorily Shostakovich's Second Waltz with a bass and treble line in harmony with another Arduino Uno.
...
const unsigned int starterPin = 13;
